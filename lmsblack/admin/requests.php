                       ...
                       <div class="span9"><br>
                        <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">ISSUE AND RETURN REQUEST</h3>
                            </div> 
                   
                    
                    <div class="span3" style="margin-left: 180px; margin-top: 100px; background-color: #4A4344">
                        <center>
                            <a href="issue_requests.php" class="btn btn-info" ><image width="100px" src="images/book2.png"></image><p>Issue Requests</p></a>
                        </center>
                    </div>
                   
                    <div class="span3" style="margin-top: 100px; background-color: #4A4344">
                        <center>

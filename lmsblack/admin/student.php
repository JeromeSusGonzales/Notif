                    ...
                    <div class="span9"><br>
                        <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">MANAGE USER</h3>
                            </div> <br>
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search"><b sty>Search:</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/ID of User" class="span8" required>
                        ...
                        <table class="table" id = "tables">
                                  <thead>
                                    <tr>
                                      <th style="background-color: maroon">Name</th>
                                      <th style="background-color: maroon">ID No.</th>
                                      <th style="background-color: maroon">Email id</th> 

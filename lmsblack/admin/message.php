            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="module" style="background-color: #4A4344">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">SEND A MESSAGE</h3>
                            </div>
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Rollno"><b style="color: white">Receiver ID No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="RollNo" name="RollNo" placeholder="ID No" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Message"><b style="color: white">Message:</b></label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn" style="background-color: red; color: white; margin-left: 150px">Add Message</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>

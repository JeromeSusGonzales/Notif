                ...
                <div class="row">
                    ...
                    <div class="span9"><br>
                        <div class="module">
                            ...
                            <div class="module-body"  style="background-color: #4A4344">
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>ISBN</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="isbn" placeholder="Title" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn" style="background-color: green; color: white; margin-left: 150px">Add Book</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
...
$sql1="insert into LMS.book (BookId,Title,Publisher,Year,Availability) values ('$isbn','$title','$publisher','$year','$availability')";

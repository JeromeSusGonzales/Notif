                        ...
                        <div class="content">
                         ...
                         <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">EDIT BOOK DETAILS</h3>
                            </div> 
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn" style="margin-left: 150px; background-color: green">Update Details</button>
                                            </div>
                                        </div>

                    ...
                    <div class="span9"><br>
                        <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">BOOK RESERVATION</h3>
                            </div> <br>
                        ...
                        <table class="table" id = "tables">
                                  <thead>
                                    <tr>
                                      ...
                                      <th style="background-color: maroon">Description</th>
                                      <th style="background-color: maroon">Reserved By</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <?php
                            ...
                            ?>
                               ...
                               <?php } ?>
                                ...
                                <center>
                                <a href="message.php" class="btn btn-success">Send Notification</a></center>
                    </div>
                    <!--/.span9-->
                </div>
            </div>

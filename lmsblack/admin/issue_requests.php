                    ...
                    <div class="span9"><br>
                        <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">ISSUE REQUEST</h3>
                            </div> <br>
                        <center>
                        <a href="issue_requests.php" class="btn btn-info" style="background-color: green">Issue Requests</a>
                       
                        <a href="return_requests.php" class="btn btn-info" style="background-color: green">Return Requests</a>
                        </center>
                       
                        <table class="table" id = "tables">
                                  <thead><br>
                                    <tr>
                                      <th style="background-color: maroon">User ID Number</th>
                                      <th style="background-color: maroon">Book Id</th>
                                      <th style="background-color: maroon">Book Name</th>
                                      <th style="background-color: maroon">Availabilty</th>

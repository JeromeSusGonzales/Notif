                    ...
                    <div class="span9"><br>
                        <div class="module">
                            <div class="module-head" style="background-color: maroon">
                                <h3 style="color: white; text-align: center">CURRENTLY ISSUED BOOKS</h3>
                            </div> <br>
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search"><b>Search:</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter ID No of User/Book Name/Book Id." class="span8" required>
                        ...
                        <table class="table" id = "tables">
                                  <thead>
                                    <tr>
                                      <th style="background-color: maroon">User ID No</th>  
                                      <th style="background-color: maroon">Book id</th>
                                      <th style="background-color: maroon">Book name</th>
                                      <th style="background-color: maroon">Issue Date</th>
                                      <th style="background-color: maroon">Due date</th>
